...
//    ======================================================================================================================
    public function productlist()
    {
        if($this->input->get('name')){
            ...
            $config['base_url'] = base_url('admin/danh-sach-du-an?name='.$this->input->get('name'));
            ...
            $config['base_url'] = base_url('admin/danh-sach-du-an');
...
//                $category = $this->input->post('category');
        ...
        if (isset($_POST['addnews'])) {
            ...
            if ($_FILES['userfile']['name'] != '') {
                if (!$this->upload->do_upload()) {
                    ...
                    $image_data['full_path'] =   $image;
                    $resized_path = 'upload/img/products/resized_path';
                    $thumbs_path = 'upload/img/products/thumbs_path';
    ...
    $this->image_lib->resize();
            ...
            redirect(base_url('admin/danh-sach-du-an'));
