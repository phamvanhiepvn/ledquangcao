        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> Quản lý nội dung trang home
                    </li>
                    <?php if(isset ($error)){?>
                        <li class="">
                ...
                <div class="body collapse in" id="div1">
                    <form class="form-horizontal" role="form" id="form1" method="POST" action="" enctype="multipart/form-data" >
                        ...
                        <div class="wrap-parent-column">
                            ...
                            <div class="wrap-column">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="file" class="form-control " name="column_top_2_icon"/>
                                        <?php if(isset($home->column_top_2_icon) && $home->column_top_2_icon!=""){ ?>
                                            <img class="display" src="<?php echo base_url($home->column_top_2_icon) ?>"/>
                                        <?php }?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="file" class="form-control " name="column_top_3_icon"/>
                                        <?php if(isset($home->column_top_3_icon) && $home->column_top_3_icon!=""){ ?>
                                            <img class="display" src="<?php echo base_url($home->column_top_3_icon) ?>"/>
                                        <?php }?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="file" class="form-control " name="column_top_4_icon"/>
                                        <?php if(isset($home->column_top_4_icon) && $home->column_top_4_icon!=""){ ?>
                                            <img class="display" src="<?php echo base_url($home->column_top_4_icon) ?>"/>
                                        <?php }?>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="wrap-parent-column">
                            ...
                            <div class="wrap-column">
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Column bot 1 icon: </label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" value="<?php echo @$home->column_bot_1_icon ?>" name="column_bot_1_icon"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Column bot 2 icon: </label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="column_bot_2_icon" value="<?php echo @$home->column_bot_2_icon ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Column bot 3 icon: </label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="column_bot_3_icon" value="<?php echo @$home->column_bot_3_icon ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Column bot 4 icon: </label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control " name="column_bot_4_icon" value="<?php echo @$home->column_bot_4_icon ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Column bot 4 text :</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control " name="column_bot_4_text" placeholder="Column bot 4 text" value="<?php echo @$home->column_bot_4_text ?>"  />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Column bot 4 content :</label>
                                    <div class="col-lg-5">
                                        <textarea class="form-control " name="column_bot_4_content"><?php echo @$home->column_bot_4_content ?></textarea>
                                    </div>
                                </div>
