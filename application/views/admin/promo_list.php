        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> Danh sách khuyến mại
                    </li>
                </ol>
            </div>
            <div class="col-md-12">
                <div class="text-left" style="padding-bottom: 15px">
                    <a href="<?php echo  base_url('admin/contact/promo-add')?>">
                        ...
                        <?php if(isset($lists)){
                            foreach($lists as $v){?>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo base_url($v->image)?>" height="80" width="100"></td>
                                    <td>
                                        <a href="<?php echo  base_url('admin/contact/promo-add/'.$v->id)?>">
                                            <button class="btn btn-xs btn-primary">Sửa</button>
                                        </a>
                                        <a href="<?php echo  base_url('admin/contact/promo-delete/'.$v->id)?>">
