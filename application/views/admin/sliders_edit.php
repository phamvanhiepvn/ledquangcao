        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> Cập nhật Sliders
                    </li>
                    <?php if(isset ($error)){?>
                        <li class="">
                ...
                <div class="body collapse in" id="div1">
                    <form class="form-horizontal" role="form" id="form1" method="POST" action="" enctype="multipart/form-data" >
                        ...
                        <div class="form-group form-group-images">
                            ...
                            <?php if(isset($images->img_url)&&file_exists($images->img_url)){?>
                                <img src="<?php echo  base_url($images->img_url) ?>" alt="" style="max-height: 100px; max-width: 100%; margin-top: 10px"/>
                            <?php }?>
                        </div>
                        <div class="form-group form-group-video">
                            <label  class="col-lg-2 control-label">Video:</label>
                            <div class="col-lg-5">
                                <input type="text" name="video" value="<?php echo $images->video_url; ?>" class="form-control"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Icon 1:</label>
                            <div class="col-lg-5">
                                <input type="text" name="icon1" class="form-control" value="<?php echo $images->icon1; ?>"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Text 1:</label>
                            <div class="col-lg-5">
                                <input type="text" name="text1" class="form-control" value="<?php echo $images->text1; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Icon 2:</label>
                            <div class="col-lg-5">
                                <input type="text" name="icon2" class="form-control" value="<?php echo $images->icon2; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Text 2:</label>
                            <div class="col-lg-5">
                                <input type="text" name="text2" class="form-control" value="<?php echo $images->text2; ?>"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" name="icon3" class="form-control" value="<?php echo $images->icon3; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Text 3:</label>
                            <div class="col-lg-5">
                                <input type="text" name="text3" class="form-control" value="<?php echo $images->text3; ?>"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Icon 4:</label>
                            <div class="col-lg-5">
                                <input type="text" name="icon4" class="form-control" value="<?php echo $images->icon4; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Text 4:</label>
                            <div class="col-lg-5">
                                <input type="text" name="text4" class="form-control" value="<?php echo $images->text4; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Icon 5:</label>
                            <div class="col-lg-5">
                                <input type="text" name="icon5" class="form-control" value="<?php echo $images->icon5; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Text 5:</label>
                            <div class="col-lg-5">
                                <input type="text" name="text5" class="form-control" value="<?php echo $images->text5; ?>" />
                            </div>
                        </div>
