...
+function (a) {
    ...
    c.prototype.close = function (b) {
        ...
        var f = a(e);
        b && b.preventDefault(), f.length || (f = d.hasClass("alert") ? d : d.parent()), f.trigger(b = a.Event("close.bs.alert")), b.isDefaultPrevented() || (f.removeClass("in"), a.support.transition && f.hasClass("fade") ? f.one(a.support.transition.end, c).emulateTransitionEnd(100) : c())
    };
    var d = a.fn.alert;
    ...
    b.DEFAULTS = {toggle: !0}, b.prototype.dimension = function () {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                this.$element.one(a.support.transition.end, a.proxy(f, this)).emulateTransitionEnd(100)[e](this.$element[0][g])
            }
        }
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                return a.support.transition ? (this.$element[c](0).one(a.support.transition.end, a.proxy(d, this)).emulateTransitionEnd(100), void 0) : d.call(this)
            }
        }
    }, b.prototype.toggle = function () {
    ...
    b.DEFAULTS = {backdrop: !0, keyboard: !0, show: !0}, b.prototype.toggle = function (a) {
        ...
        this.$element.trigger(d), this.isShown || d.isDefaultPrevented() || (this.isShown = !0, this.escape(), this.$element.on("click.dismiss.modal", '[data-dismiss="modal"]', a.proxy(this.hide, this)), this.backdrop(function () {
            ...
            }).emulateTransitionEnd(100) : c.$element.focus().trigger(e)
        }))
    }, b.prototype.hide = function (b) {
        b && b.preventDefault(), b = a.Event("hide.bs.modal"), this.$element.trigger(b), this.isShown && !b.isDefaultPrevented() && (this.isShown = !1, this.escape(), a(document).off("focusin.bs.modal"), this.$element.removeClass("in").attr("aria-hidden", !0).off("click.dismiss.modal"), a.support.transition && this.$element.hasClass("fade") ? this.$element.one(a.support.transition.end, a.proxy(this.hideModal, this)).emulateTransitionEnd(100) : this.hideModal())
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            d ? this.$backdrop.one(a.support.transition.end, b).emulateTransitionEnd(100) : b()
        } else!this.isShown && this.$backdrop ? (this.$backdrop.removeClass("in"), a.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(a.support.transition.end, b).emulateTransitionEnd(100) : b()) : b && b()
    };
    var c = a.fn.modal;
    ...
    b.DEFAULTS = {animation: !0, placement: "top", selector: !1, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1}, b.prototype.init = function (b, c, d) {
        ...
        return this.$element.trigger(e), e.isDefaultPrevented() ? void 0 : (d.removeClass("in"), a.support.transition && this.$tip.hasClass("fade") ? d.one(a.support.transition.end, b).emulateTransitionEnd(100) : b(), this.$element.trigger("hidden.bs." + this.type), this)
    ...
    b.prototype.show = function () {
        ...
        g ? f.one(a.support.transition.end, e).emulateTransitionEnd(100) : e(), f.removeClass("in")
    };
    var c = a.fn.tab;
    a.fn.tab = function (c) {
        return this.each(function () {
