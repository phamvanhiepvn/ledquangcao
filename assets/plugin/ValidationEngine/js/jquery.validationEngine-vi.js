        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    ...
                    "alertTextCheckboxMultiple": "* Hãy chọn ít nhất 1 ",
                    "alertTextCheckboxe": "* Hãy chọn ít nhất 1 "
                },
                "minSize": {
                    "regex": "none",
                    "alertText": "* Minimum ",
                ...
                "minCheckbox": {
                    "regex": "none",
                    "alertText": "* Hãy chọn ",
                    "alertText2": " trong các lựa chọn "
                },
                "equals": {
                    "regex": "none",
                    "alertText": "* Giá trị không trùng nhau"
                },
                "phone": {
                ...
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "* Không phải là 1 số nguyên"
                },
                "number": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,
                    "alertText": "* Không phải là 1 số thực"
                },
                "date": {
                    // Date in ISO format. Credit: bassistance
                    "regex": /^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}$/,
                    "alertText": "* Ngày tháng không hợp lệ, định dạng đúng là NNNN-TT-NN (năm/tháng/ngày)"
                },
                "ipv4": {
